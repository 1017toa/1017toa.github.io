export const blogData = [
    {
        id: 1,
        title: 'Notion Blog',
        description: '멀티 클라우드 엔지니어 양성 과정 TIL을 정리한 노션 블로그입니다.',
        date: '',
        image: 'https://www.notion.so/cdn-cgi/image/format=auto,width=2048,quality=100/front-static/pages/about/about-01-v2.png',
        url: 'https://inky-anise-4d2.notion.site/f49ed6ebca37474abad9ee7d8dba7155'
    },
    // {
    //     id: 2,
